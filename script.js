...
btn.addEventListener('click',()=>{
    ...
    setTimeout(async() =>{
       ...
       if(data){
            ...
            let address = data.results[0].location.street.number+', '+data.results[0].location.street.name+', '+data.results[0].location.city+', '+data.results[0].location.state+', '+data.results[0].location.country+'- '+data.results[0].location.postcode+'.'
